...
form.addEventListener("submit", (e) => {
  ...
  formToConvert.login = login;
  formToConvert.email = email;
  formToConvert.password = password;
  formToConvert.radio = radio.value;
  formToConvert.checkbox = checkbox.value;
  formToConvert.textarea = textarea.value;

  let convertToJson = JSON.stringify(formToConvert);
